...
9. Keep causal LR scheduling epoch-based: 32-epoch server runs use `warmup_steps: 2`, `total_steps: 32`, and encoder LR scale 0.5.
10. After meaningful work, update `docs/progress.md` and refresh `docs/next.md`.
11. Update `docs/spec.md` and `docs/decisions.md` only when project direction or durable decisions change.
